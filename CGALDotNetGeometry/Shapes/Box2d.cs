...
namespace CGALDotNetGeometry.Shapes
{
    ...
    public struct Box2d : IEquatable<Box2d>
    {
        ...
        public static Box2d operator *(MATRIX2 m, Box2d box)
        {
            return new Box2d(m * box.Min, m * box.Max);
        }

        public static Box2d operator *(MATRIX3 m, Box2d box)
        {
            return new Box2d(m * box.Min, m * box.Max);
        }

        public static Box2d operator *(MATRIX4 m, Box2d box)
        {
            return new Box2d(m * box.Min, m * box.Max);
        }
        ...
        public bool Intersects(Box2d box, bool includeBorder = true)
        {
            if (includeBorder)
            {
        ...
        public bool Contains(Box2d box, bool includeBorder = true)
        {
            if (includeBorder)
            {
        ...
        public static Box2d CalculateBounds(POINT2 a, POINT2 b)
        {
            ...
            return new Box2d(new POINT2(xmin, ymin), new POINT2(xmax, ymax));
        }
