...
namespace CGALDotNetGeometry.Shapes
{
    ...
    public struct Box3i : IEquatable<Box3i>
    {
        ...
        {
            return new Box3i((POINT3)box.Min, (POINT3)box.Max);
        }
        ...
        public bool Intersects(Box3i box, bool includeBorder = true)
        {
            if (includeBorder)
            {
        ...
        public bool Contains(Box3i box, bool includeBorder = true)
        {
            if (includeBorder)
            {
