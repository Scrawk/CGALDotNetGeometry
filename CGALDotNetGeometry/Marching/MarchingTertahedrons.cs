...
namespace CGALDotNetGeometry.Marching
{
    public class MarchingTertrahedron : MarchingBase
    {

        private Point3d[] EdgeVertex { get; set; }

        private Point3d[] CubePosition { get; set; }

        private Point3d[] TetrahedronPosition { get; set; }

        private double[] TetrahedronValue { get; set; }

        public MarchingTertrahedron()
        {
            EdgeVertex = new Point3d[6];
            CubePosition = new Point3d[8];
            TetrahedronPosition = new Point3d[4];
            TetrahedronValue = new double[4];
        }

        /// <summary>
        /// MarchCubeTetrahedron performs the Marching Tetrahedrons algorithm on a single cube
        /// </summary>
        protected override void March(double x, double y, double z, float[] cube, List<Point3d> vertList, List<int> indexList)
        {
        ...
        /// </summary>
        private void MarchTetrahedron(IList<Point3d> vertList, IList<int> indexList)
        {
