...
namespace CGALDotNetGeometry.Nurbs
{
	...
	/// </summary>
	public struct NurbsCurveParams2d
	{
		public int degree;
	...
	public class NurbsCurve2d : BaseNurbsCurve2d
	{
		...
		public NurbsCurve2d(NurbsCurveParams2d param)
		{
			m_degree = param.degree;
			Knots = param.knots.ToArray();

			var control_points = param.controlPoints;
	...
	public class RationalNurbsCurve2d : BaseNurbsCurve2d
	{
		...
		/// </summary>
		/// <param name="param">The curves parameters.</param>
		public RationalNurbsCurve2d(NurbsCurveParams2d param)
		{
			m_degree = param.degree;
			Knots = param.knots.ToArray();
			HomogeneousControlPoints = param.controlPoints.ToArray();
		}
